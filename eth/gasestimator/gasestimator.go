...
func mantleArsiaCheckFunds(gasLimit uint64, call *core.Message, opts *Options, feeCap *big.Int) error {
	if !opts.Config.IsMantleArsia(opts.Header.Time) || call.RunMode == core.GasEstimationWithSkipCheckBalanceMode || opts.L1CostFunc == nil || opts.OperatorCostFunc == nil || feeCap.BitLen() == 0 {
		return nil
	}
