...
var (
	// BaseFee 0.1 Gwei, temporary use
...
func (w *worker) buildPayload(args *BuildPayloadArgs) (*Payload, error) {
	...
	empty, _, err := w.getSealingBlock(args.Parent, args.Timestamp, args.FeeRecipient, args.Random, args.Withdrawals, true, args.Transactions, args.GasLimit, BaseFee)
	if err != nil {
		return nil, err
	}
	...
	go func() {
		...
		for {
			...
			case <-timer.C:
				start := time.Now()
				block, fees, err := w.getSealingBlock(args.Parent, args.Timestamp, args.FeeRecipient, args.Random, args.Withdrawals, false, args.Transactions, args.GasLimit, args.BaseFee)
				if err == nil {
