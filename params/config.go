...
type ChainConfig struct {
	...
	GasFeeUpgradeTime *uint64 `json:"gasFeeUpgradeTime,omitempty"` // Gas fee model restruct, optimize tokenRatio
...
// IsGasFeeUpgrade GasFeeUpgrade returns whether time is either equal to the GasFeeUpgrade fork time or greater.
func (c *ChainConfig) IsGasFeeUpgrade(time uint64) bool {
	return isTimestampForked(c.GasFeeUpgradeTime, time)
}
...
type Rules struct {
	...
	IsMetaTxV2, IsGasFeeUpgrade                             bool
}
...
func (c *ChainConfig) Rules(num *big.Int, isMerge bool, timestamp uint64) Rules {
	...
	return Rules{
		...
		IsGasFeeUpgrade:           c.IsGasFeeUpgrade(timestamp),
		// Optimism
