...
var (
	...
	MantleSepoliaQA7ChainId = big.NewInt(1115511107)
...
var (
	...
	MantleSepoliaQA7UpgradeConfig = MantleUpgradeChainConfig{
		ChainID:               MantleSepoliaQA7ChainId,
		BaseFeeTime:           u64Ptr(0),
		BVMETHMintUpgradeTime: u64Ptr(0),
		MetaTxV2UpgradeTime:   u64Ptr(0),
		...
		MantleLimbTime:        u64Ptr(1_766_473_200),
	}
...
func GetUpgradeConfigForMantle(chainID *big.Int) *MantleUpgradeChainConfig {
	...
	case MantleSepoliaQA7ChainId.Int64():
		return &MantleSepoliaQA7UpgradeConfig
