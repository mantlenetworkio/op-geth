...
var (
	...
	// todo: The operator fee portion of the transaction fee accumulates at this predeploy
...
const (
	...
	P256VerifyGasEverest uint64 = 3450 // secp256r1 elliptic curve signature verifier gas price (RIP-7212 value)
